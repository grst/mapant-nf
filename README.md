 ...
 * `PULLAUTA_GRID` based on the grids defined earlier, downloads the tiles, runs `karttapullautin`, and cleans up the LAZ files. Downloading and processing is done within one process to save disk space. The process generates the raw png tiles and collects
